...
bool Engine::fontInit() {
    if (!continueText.openFont(30) || !newGameText.openFont(30) || !gameModeText.openFont(25) || !timeModeText.openFont(25) ||
        !scoreText.openFont(30) || !highscoreText.openFont(30) || !scores.openFont(35) ||
        !highscores.openFont(35) || !times.openFont(75) || !startNotice.openFont(100) || !soundText.openFont(30) || !exitText.openFont(35))
        return false;
